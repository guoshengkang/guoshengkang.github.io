...
- **Jiayan Xiang**, Wanjun Chen, Yang Wang, Bowen Liang, Zihao Liu, **Guosheng Kang***. Interactive Web API Recommendation for Mashup Development based on Light Neural Graph Collaborative Filtering. **International Conference on Computer Supported Cooperative Work in Design**. IEEE Computer Society, pp. 1716-1721, 2023.  (CCF Rank C) [PDF](https://pan.baidu.com/s/1P786Pj5IuhK_eDe7B6E3sQ?pwd=kang)
