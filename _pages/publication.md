...
- **Jiayu Li**, **Qingping Li**, Yan Li, Xin Ai, Jie Chen, Jiayan Xiang, **Guosheng Kang***. CS-LightGCL: Composition-Supervised LightGCL for Interactive Web API Recommendation.  **International Joint Conference on Neural Networks**. IEEE Computer Society, pp. 1-8, 2025. (CCF C) [PDF](https://pan.baidu.com/s/1S3pqn5uKJ9xA-RQ6QtJ9Rg?pwd=kang).
...
* **Yang Wang**, Zhenzhen Yuan, **Guosheng Kang***, Jianxun Liu, Buqing Cao, Yong Xiao. Graph-based Multi-view Clustering for Web services. International Symposium on Parallel and Distributed Processing with Applications. IEEE Computer Society, pp. 567-572, 2023.  (CCF Rank C) [PDF](https://pan.baidu.com/s/1PENRVZhPih5cHpbgPmveqw?pwd=kang)
...
* **Bowen Liang**, **Guosheng Kang***, Jianxun Liu, Buqing Cao, Jiayan Xiang. Attentional Neural Factorization Machine for Web Services Classification via Exploring Content and Structural Semantics. **International Joint Conference on Neural Networks**. IEEE Computer Society, pp. 1-8, 2022. (CCF C) [PDF](https://pan.baidu.com/s/1K-Z13WYHR2sae-TRRfFPUw?pwd=kang)
